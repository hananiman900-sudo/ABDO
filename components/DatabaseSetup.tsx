          ...
          {/* V33 UPDATE BLOCK */}
           <div className="mb-8 p-4 border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20 rounded-r-lg shadow-lg animate-fade-in">
             <div className="flex items-center gap-2 mb-2">
                <Handshake className="text-yellow-600 dark:text-yellow-400" size={24}/>
                <h3 className="text-xl font-bold text-yellow-600 dark:text-yellow-400">
                   V33: تفعيل طلبات الشركاء
                </h3>
             </div>
             <p className="mb-3 text-sm text-gray-700 dark:text-gray-300 font-bold">
                إضافة عمود status لجدول الشركاء لتفعيل نظام الموافقة.
             </p>
             <CodeBlock title="SQL V33 Code" code={v33SQL.trim()} />
          </div>
