...
import { X, Copy, Database, Image as ImageIcon, Users, AlertTriangle, ShieldAlert, CheckCircle, Unlock, Bell, ShoppingBag, ListPlus, UserCheck, Megaphone, ShieldCheck, Layers, Zap, Tag, FileText, MessageSquare, ThumbsUp, BrainCircuit, Rocket, Wrench, Handshake } from 'lucide-react';
...
CREATE POLICY "Public Update Partners" ON public.affiliate_partners FOR UPDATE USING (true); -- Needed for updating earnings
          ...
          {/* V36 UPDATE BLOCK */}
           <div className="mb-8 p-4 border-l-4 border-orange-500 bg-orange-50 dark:bg-orange-900/20 rounded-r-lg shadow-lg animate-fade-in">
             <div className="flex items-center gap-2 mb-2">
                <Handshake className="text-orange-600 dark:text-orange-400" size={24}/>
                <h3 className="text-xl font-bold text-orange-600 dark:text-orange-400">
                   V36: FIX Affiliate Permissions
                </h3>
             </div>
             <p className="mb-3 text-sm text-gray-700 dark:text-gray-300 font-bold">
                ⚠️ هام جداً: هذا الكود يمنح الأدمن صلاحية تحديث رصيد المسوقين. بدونه لن يتم تحويل الأرباح.
             </p>
             <CodeBlock title="SQL V36 Code" code={v36SQL.trim()} />
          </div>
