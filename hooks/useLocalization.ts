...
export const translations: Translations = {
  ...
  // --- NEW ---
  requestBoost: { ar: 'طلب إعلان ممول', en: 'Request Paid Ad', fr: 'Demander Publicité' },
  boostDesc: { ar: 'إعلان يظهر لجميع المستخدمين لمدة 3 أيام', en: 'Ad shown to all users for 3 days', fr: 'Pub visible pour tous 3 jours' },
  price50DH: { ar: '50 درهم', en: '50 DH', fr: '50 DH' },
  submitRequest: { ar: 'إرسال الطلب', en: 'Submit Request', fr: 'Envoyer Demande' },
  requestSent: { ar: 'تم إرسال الطلب للمراجعة', en: 'Request Sent', fr: 'Demande Envoyée' },
  waitForCall: { ar: 'المرجو انتظار اتصال من الإدارة', en: 'Please wait for admin call', fr: 'Attendez l\'appel admin' },
};
